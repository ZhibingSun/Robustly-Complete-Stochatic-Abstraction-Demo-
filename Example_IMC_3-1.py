...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 20 11:08:41 2023
...
fp3 = lambda x: [0, 0, 1]
fp = [fp1, fp2, fp3]
b = [[0.001, 0, 0], [0, 0.001, 0], [0, 0, 0.001]]
...
"""
dirname = 'Example_IMC_3-results'
if not os.path.isdir('./' + dirname):
    os.mkdir(dirname)
"""

#output basic information
pd.DataFrame(imc.dictionary).to_csv('Example_IMC_3-results/Dictionary.csv')
pd.DataFrame({'Grid Point': list(imc.getQ)}).\
    to_csv('Example_IMC_3-results/Grid_points.csv')
...
tic1 = time.time()
"""
with open('Example_IMC_3-results/IMC_abstraction_matrix_{}.txt'.format(i+1), 'w') as f:
...
with open('Example_IMC_3-results/IMC_abstraction_matrix_new_{}.txt'.format(i+1), 'w') as f:
    count = 0
